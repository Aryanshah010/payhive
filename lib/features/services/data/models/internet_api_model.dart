...
class InternetServiceApiModel {
  ...
  factory InternetServiceApiModel.fromJson(Map<String, dynamic> json) {
    return InternetServiceApiModel(
      id: _extractId(json),
  ...
  InternetServiceEntity toEntity() {
...
class InternetPaymentReceiptApiModel {
  ...
  factory InternetPaymentReceiptApiModel.fromJson(Map<String, dynamic> json) {
    return InternetPaymentReceiptApiModel(
  ...
  InternetPaymentReceiptEntity toEntity() {
    return InternetPaymentReceiptEntity(
      receiptNo: receiptNo,
...
class PayInternetResultApiModel {
  final String transactionId;
  final InternetPaymentReceiptApiModel receipt;
  final bool idempotentReplay;

  const PayInternetResultApiModel({
    required this.transactionId,
    required this.receipt,
    required this.idempotentReplay,
  });

  factory PayInternetResultApiModel.fromJson(Map<String, dynamic> json) {
    return PayInternetResultApiModel(
      transactionId: _asString(json['transactionId']),
      receipt: InternetPaymentReceiptApiModel.fromJson(_asMap(json['receipt'])),
      idempotentReplay: _asBool(json['idempotentReplay']),
    );
  }

  PayInternetResultEntity toEntity() {
